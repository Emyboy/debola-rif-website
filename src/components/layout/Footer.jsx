...
<div className="container px-6  md:flex justify-center items-center   ">
        ...
        <div className="md:col-span-2  pt-6 md:pt-0 md:grid md:gap-16 md:grid-cols-4 ">
          ...
          <div className="pb-4 md:pb-0">
            ...
            <ul>
              <li className="text-[16px] font-medium py-2 capitalize text-[#5c5860a8]">
              <Link href="/"> Home </Link>
              </li>
              <li className="text-[16px] font-medium py-2 capitalize text-[#5c5860a8]">
          ...
          <div className="pb-4 md:pb-0">
            <h6 className="font-bold text-green-shad2 ">contact</h6>
            <ul>
              <li className="text-[16px] font-medium py-2 capitalize text-[#5c5860a8]">
          ...
          <div className="pb-4 md:pb-0">
            ...
            <ul className="grid grid-cols-4 items-center pb-3 md:pb-0 justify-center  w-[11rem]">
              <li className="text-[16px] font-medium py-2 capitalize text-[#5c5860a8]">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
              </li>
              <li className="text-[16px] font-medium py-2 capitalize text-[#5c5860a8]">
                <a href="https://www.linkedin.com/company/royal-iwere-foundation/">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6" viewBox="0 0 448 512"><path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/>
              </svg>
              </a>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6" viewBox="0 0 448 512"><path d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z"/></svg>
              </li>
              <li className="text-[16px] font-medium  py-2 capitalize text-[#5c5860a8]">
