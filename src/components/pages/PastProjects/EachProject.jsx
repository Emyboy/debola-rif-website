...
const EachProject = ({ location, date, title, img, link }) => {
  ...
  <article class="mx-auto max-w-smw-full  shadow-xl bg-cover bg-center min-h-150 transform duration-500 hover:-translate-y-2 cursor-pointer group" style={{
    backgroundImage: `url('${img}')`,
  }}>
  <div class="bg-black bg-opacity-20 min-h-150 px-10 flex flex-col pt-96 hover:bg-opacity-75 transform duration-300">
